...
export interface ClashOfClansWarLogClan
  extends Pick<
    ClashOfClansBaseClan,
    "tag" | "name" | "badgeUrls" | "clanLevel"
  > {
  attacks: number;
  stars: number;
...
export interface ClashOfClansMember {
  ...
  expLevel: number;
  league:
    | Pick<ClashOfClansWarLeague, "id" | "name">
    | Record<"iconUrls", ClashOfClansBadgeUrls>;
  trophies: number;
...
export type ClashOfClansWarSize =
  | 5
  | 10
  | 15
  | 20
